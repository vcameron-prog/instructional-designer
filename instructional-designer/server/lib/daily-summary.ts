...
async function fetchDailyStats(): Promise<DailySummaryStats> {
  ...
  const [newUsers, contentRows, totals] = await Promise.all([
    db
      .select({
...
function buildEmailHtml(stats: DailySummaryStats, date: string): string {
  const hasActivity = stats.newUsers.length > 0 || stats.contentGenerated > 0;
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
        ...
        <tr>
          <td style="background:#8b0000;padding:24px 24px 20px;text-align:center;">
            <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;">BSU Instructional Designer</p>
        ...
        <tr>
          <td style="padding:20px 24px 8px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="width:50%;text-align:center;padding:12px;background:#f9f9f9;border-radius:6px;">
        ...
        <tr>
          <td style="padding:20px 24px 8px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="width:50%;text-align:center;padding:10px;border:1px solid #e5e5e5;border-radius:6px;">
        ...
        <tr>
          <td style="padding:20px 24px;border-top:1px solid #f0f0f0;text-align:center;">
            <p style="margin:0;font-size:12px;color:#999;">
              Sent automatically by BSU Instructional Designer
            </p>
          </td>
        </tr>
