...
- Name: tools-integration.spec.ts >> [integration] Oversized image upload — 400 before AI call >> math-ocr endpoint returns 400 for a >5 MB image
- Location: instructional-designer/e2e/tools-integration.spec.ts:543:3

# Error details

```
Error: oversized upload to /api/tools/math-ocr must return 400, not 500
