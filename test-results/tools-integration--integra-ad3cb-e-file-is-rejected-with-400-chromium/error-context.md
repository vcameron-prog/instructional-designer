...
- Name: tools-integration.spec.ts >> [integration] Math OCR — real server + AI response >> non-image file is rejected with 400
- Location: instructional-designer/e2e/tools-integration.spec.ts:489:3
