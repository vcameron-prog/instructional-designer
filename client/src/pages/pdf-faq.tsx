...
const FAQ_SECTIONS: FAQSection[] = [
  {
    ...
    items: [
      { question: "What does this tool do?", answer: "This tool converts PDF documents into accessible HTML files that meet ADA Title II and WCAG 2.1 Level AA requirements. It uses AI to analyze your document's structure, add proper headings, image descriptions, reading order, and other accessibility features." },
      ...
      { question: "Do I need any technical skills to use this?", answer: "No. Simply log in, drag and drop your PDF, and the tool handles the rest. You'll get a downloadable Word document or HTML file that's ready to share with students." },
      { question: "What file types can I upload?", answer: "Currently, the tool accepts PDF files only. If you have documents in other formats (Word, PowerPoint, etc.), save them as PDF first, then upload the PDF here." },
    ],
  },
  {
  ...
  },
  {
    title: "Privacy & Data",
    items: [
      { question: "Is my document data secure?", answer: "Yes. Your documents are processed securely and are only accessible to you through your authenticated account." },
      { question: "Who can see my uploaded documents?", answer: "Only you can see your uploaded documents and conversion history. Each user's data is private." },
    ],
  },
];
