...
export function PoweredByFooter() {
  return (
    <footer className="mt-12 py-8 bg-gray-800 dark:bg-gray-900" data-testid="footer-powered-by">
      <div className="container mx-auto px-4 space-y-4">
        ...
        <p className="text-center text-sm text-gray-300 flex items-center justify-center gap-2" style={{ textWrap: "balance" }} data-testid="text-powered-by">
          <Sparkles className="w-4 h-4 flex-shrink-0" />
          Powered by AI to help Bridgewater State University faculty create accessible, engaging course materials
        </p>
        <p className="text-center text-xs text-gray-400 flex items-center justify-center gap-2" style={{ textWrap: "balance" }} data-testid="text-privacy">
