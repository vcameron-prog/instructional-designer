...
export const ROUTE_VISIBILITY: RouteVisibility[] = [
  ...
  { path: "/accessibility-tools/url-scanner",    requiresAuth: false, showSignIn: false },
  { path: "/accessibility-tools/color-contrast", requiresAuth: false, showSignIn: false },
  { path: "/accessibility-tools/alt-text",       requiresAuth: false, showSignIn: false },
  { path: "/accessibility-tools/math-ocr",       requiresAuth: false, showSignIn: false },
